...
namespace TP8
{
    public sealed partial class ZoneCheckBox : UserControl
    {
        // Code here is a variant of ZoneButton class... doesn't use floating checkmark, instead uses regular checkbox.

        static ZoneCheckBox()
        {
            // Give these different names than button properties so don't have to deal with override issues
            BackgroundColorProperty =
                DependencyProperty.Register("BackgroundColor", typeof(Color), typeof(ZoneCheckBox), new PropertyMetadata(Colors.Cyan));

            ContentAutoForegroundProperty =
                DependencyProperty.Register("ContentAutoForeground", typeof(string), typeof(ZoneCheckBox), new PropertyMetadata("Dummy Text"));

            //CheckMarkVisibilityProperty =
            //    DependencyProperty.Register("CheckMarkVisibility", typeof(Visibility), typeof(ZoneCheckBox), new PropertyMetadata(Visibility.Visible));

            ZoneCheckBoxWidthProperty =
                DependencyProperty.Register("ZoneCheckBoxWidth", typeof(int), typeof(ZoneCheckBox), new PropertyMetadata(130));
        }
        ...
        public static DependencyProperty ZoneCheckBoxWidthProperty { private set; get; }
        ...
        public ZoneCheckBox(string Name_, Color BackgroundColor_, string ContentAutoForeground_)
        {
            this.InitializeComponent();
            this.Name = Name_;
        ...
        public Color BackgroundColor // differs from Background which is SolidBrush
        {
            set {
                ...
                this.checkbox.Background = new SolidColorBrush(value);
            }
...
/*        public Visibility CheckMarkVisibility
        ...
        public int ZoneCheckBoxWidth
        {
            set
            {
                SetValue(ZoneCheckBoxWidthProperty, value);
                this.checkbox.Width = value;
                //double dvalue = value;
                //this.checkMark.SetValue(Canvas.LeftProperty, (int)(dvalue * 0.75));
            }
            get { return (int)GetValue(ZoneCheckBoxWidthProperty); }
        }
        ...
        public bool IsChecked
        {
            ...
            get { return (bool)this.checkbox.IsChecked; }
        }
